  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[var(--canvas)] p-6 text-center">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-bold tracking-[-0.04em]">That project is not in your library</h1>
        ...
        <Link href="/inventory" className={cn(buttonVariants({ variant: "secondary" }), "mt-5")}><ArrowLeft className="size-4" /> Back to Library</Link>
      </div>
    </main>
  );
}
